...
function pageEditForm_jwysiwyg(){
    if(!wysiwygConfig) wysiwygConfig = {
        contentStyle: false,
        minHtmlHeading: 2
    };
    ...
    var wysiwyg = $('#frmpageEditForm-text').wysiwyg({
        ...
        controls: {
            ...
            h1 : {
                visible : 1 >= wysiwygConfig.minHtmlHeading
            },
            h2 : {
                visible : 2 >= wysiwygConfig.minHtmlHeading
            },
            h3 : {
                visible : 3 >= wysiwygConfig.minHtmlHeading
            },
...
function metalist(){
    ...
    // delete button
    jsmeta.delegate('.del','click',function (){
        $(this).parent().fadeOut()
    });
...
function editaceCislaForm_changes_catcher(){
    ...
    $('#editaceCislaForm').each(function() {
        var that = $(this).data('initialForm', $(this).serialize());
		that.submit(function(){ that.data('initialForm', that.serialize())  });
